...
import { TagInput } from '@/app/mobile/components/base/TagInput/TagInput'
import { MobileCategorySelector } from '@/app/mobile/components/MobileCategorySelector/MobileCategorySelector'
import { validateItemForm, buildCreateItemRequest, buildUpdateItemRequest } from '@/features/items/components/ItemForm/validation'
import styles from '@/app/mobile/pages/ItemFormPage/ItemFormPage.module.css'
